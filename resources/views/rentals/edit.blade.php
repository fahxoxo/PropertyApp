        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <h3 class="mb-0">✏️ แก้ไขสัญญาเช่า ({{ $rental->code }})</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('rentals.update', $rental) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" value="{{ $rental->code }}" disabled>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('deposit') is-invalid @enderror" 
                                   id="deposit" name="deposit" value="{{ old('deposit', $rental->deposit) }}" step="0.01" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('advance_rent') is-invalid @enderror" 
                                   id="advance_rent" name="advance_rent" value="{{ old('advance_rent', $rental->advance_rent) }}" step="0.01" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('start_date') is-invalid @enderror" 
                                   id="start_date" name="start_date" value="{{ old('start_date', $rental->start_date) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            @if($rental->contract_image)
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <img src="{{ asset('storage/' . $rental->contract_image) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="active" {{ old('status', $rental->status) === 'active' ? 'selected' : '' }}>✅ ใช้งาน</option>
                                <option value="closed" {{ old('status', $rental->status) === 'closed' ? 'selected' : '' }}>⚫ ปิด</option>
                            </select>
